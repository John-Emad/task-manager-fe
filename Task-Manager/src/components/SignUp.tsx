...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 bg-linear-to-br from-[#1f006c] via-[#2d0a8f] to-[#53b3cb]">
      ...
      <div className="relative bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-10 w-full max-w-md shadow-2xl backdrop-blur-sm">
        ...
        <div className="flex flex-col items-center mb-6 sm:mb-8">
          <div className="relative mb-3 sm:mb-4">
            {/* Logo Circle */}
            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-linear-to-br from-[#1f006c] to-[#53b3cb] rounded-2xl flex items-center justify-center shadow-lg transform hover:scale-105 transition-transform duration-300">
              <svg
          ...
          <h1 className="text-3xl sm:text-4xl font-bold bg-linear-to-r from-[#1f006c] to-[#53b3cb] bg-clip-text text-transparent mb-2">
            Task
          </h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              />
              {errors.firstName && (
                <span className="text-xs text-[#f15946] flex items-center gap-1">
                  <svg
                    className="w-3 h-3"
                    fill="currentColor"
                    viewBox="0 0 20 20"
